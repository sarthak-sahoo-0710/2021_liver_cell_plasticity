...
# check
               'lm_tgfbr2_tgfb' : 2,  #from 2.25 # height of the hepatoblast-cholangiocyte sigmoid (decreaing it removes bistable region)
               'phi_tgfbr2_tgfb': 25000,
               'n_tgfbr2_tgfb'  : 3,

# check
               'lm_tgfbr2_sox9' : 0.35, # from 0.35,  # cebpa tgfbr2 bistabilty vanishes if reduced
               'phi_tgfbr2_sox9': 4000, # if increased to 7000 causes the upper arm to shift up by 2-3k
               'n_tgfbr2_sox9'  : 3,
